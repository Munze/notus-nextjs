  ...
  return (
    <>
      ...
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px">
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-blueGray-600">
                Advanced Composite Structures - WE FIX BLADES
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna aliqua.
                Rhoncus est pellentesque elit ullamcorper. Id venenatis a
              ...
              <div className="mt-12">
                <a
                  href="https://acs-composites.com/home"
                  target="_blank"
        ...
        <img
          className="absolute top-0 b-auto right-0 pt-2 sm:w-6/12 -mt-48 sm:mt-0 w-10/12 max-h-860-px"
          src="/img/vortex.png"
          alt="Vortex color image"
        />
      </section>
